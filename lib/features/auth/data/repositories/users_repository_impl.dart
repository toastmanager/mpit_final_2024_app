...
class UsersRepositoryImpl implements UsersRepository {
  ...
  Future<UserDto> updateUser(
    ...
    // if (filePath != null) {
    //   final avatarPutResponse = await restApi.v1UsersIdAvatarPut(
    //     id: id.toString(),
    //     file: filePath,
    //   );
    ...
    final response = await restApi.v1UsersIdPatch(
      id: id.toString(),
      body: form,
    );
  ...
  Future<bool> clearAvatar(int id) async {
    ...
    // final response = await restApi.v1UsersIdAvatarDelete(id: id.toString());
